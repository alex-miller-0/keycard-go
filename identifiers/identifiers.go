...
var (
	...
	PackageAID      = []byte{0xA0, 0x00, 0x00, 0x08, 0x20, 0x00, 0x01}
	KeycardAID      = []byte{0xA0, 0x00, 0x00, 0x08, 0x20, 0x00, 0x01, 0x01}
	NdefAID         = []byte{0xA0, 0x00, 0x00, 0x08, 0x20, 0x00, 0x01, 0x02}
